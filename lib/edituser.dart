...
class UserEditProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserEditProfilePage(title: "Edit User",),
    );
  }
}

class UserEditProfilePage extends StatefulWidget {
  const UserEditProfilePage({super.key, required this.title});
...
class _UserEditProfilePageState extends State<UserEditProfilePage> {
  ...
  Future<void> chooseImage() async {
    ...
    paths=choosedimage!.path.toString();
    setState(() {
  ...
  Future<void>SignupUser()async{
    ...
    try{
      ...
      String ulid = ips.getString("dlid").toString();
      ...
      var data = await http.post(
          Uri.parse(url+"and_Update_Patient_management"),
          body: {
            'nm':nm,
            "phn":phn,
            "dob":dob,
  ...
  Future<void> _getNames() async {
    ...
    var data = await http.post(Uri.parse(url+"and_get_userdetails"),body: {
      'dlid':lid
    });
    print("------------------------------hoiiiiiii---------------");
    print(data);
    ...
    name.text=jsonData['u_name'].toString();


    // DateTime tempDate = new DateFormat("yyyy-MM-dd hh:mm:ss").parse(jsonData['v_email'].toString(););

    email.text=jsonData['u_email'].toString();
    dateController.text=jsonData['u_dob'].toString();
    phone.text=jsonData['u_phone'].toString();
    place.text=jsonData['u_place'].toString();
    post.text=jsonData['u_post'].toString();
    pin.text=jsonData['u_pin'].toString();
    district.text=jsonData['u_district'].toString();
    state.text=jsonData['u_state'].toString();

    selectedGender=jsonData['u_gender'].toString();
    ...
    setState(() {
      ...
      src=url+jsonData['u_photo'].toString();
