...
class VolSurveynewnew extends StatelessWidget {
  const VolSurveynewnew({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const VolSurveynewnewPage(title: 'Update Profile'),
    );
  }
}

class VolSurveynewnewPage extends StatefulWidget {
  const VolSurveynewnewPage({super.key, required this.title});


  final String title;

  @override
  State<VolSurveynewnewPage> createState() => _VolSurveynewnewPageState();
}

class _VolSurveynewnewPageState extends State<VolSurveynewnewPage> {
